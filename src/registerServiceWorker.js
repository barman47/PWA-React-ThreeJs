                ...
                installingWorker.onstatechange = () => {
                    ...
                    if (installingWorker.state === 'installed') {
                        ...
                        if (navigator.serviceWorker.controller) {
                            ...
                            // A ce stade, le contenu précaché mis à jour a été récupéré,
                            // mais le sw précédent servira toujours le plus âgé
                            // jusqu'à ce que tous les onglets clients soient fermés.
                            ...
                            if (config && config.onUpdate) {
                                ...
                                console.log('On affiche le popup ');

                            }
                        } else {
                            // A ce stade, tout a été précaché.
                            // C'est le moment idéal pour afficher
